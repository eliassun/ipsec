...
variable "subnet_prod_vpc_2" {
    type = list
}

variable "prod_2_route_table_cidr_v4" {
    type = string
}

variable "prod_2_route_table_cidr_v6" {
    type = string
}

variable "web_server_02_nic_ips" {
    type = list
}
